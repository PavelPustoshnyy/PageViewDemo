...
public class PageViewTypedDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final Serializer<PageView> pageViewSerializer = new JsonPOJOSerializer<PageView>();
        serdeProps.put("JsonPOJOClass", PageView.class);
        pageViewSerializer.configure(serdeProps, false);

        final Deserializer<PageView> pageViewDeserializer = new JsonPOJODeserializer<PageView>();
        serdeProps.put("JsonPOJOClass", PageView.class);
        pageViewDeserializer.configure(serdeProps, false);

        final Serde<PageView> pageViewSerde = Serdes.serdeFrom(pageViewSerializer, pageViewDeserializer);

        final Serializer<UserProfile> userProfileSerializer = new JsonPOJOSerializer<UserProfile>();
        serdeProps.put("JsonPOJOClass", UserProfile.class);
        userProfileSerializer.configure(serdeProps, false);

        final Deserializer<UserProfile> userProfileDeserializer = new JsonPOJODeserializer<UserProfile>();
        serdeProps.put("JsonPOJOClass", UserProfile.class);
        ...
        final Serializer<WindowedPageViewByRegion> wPageViewByRegionSerializer = new JsonPOJOSerializer<WindowedPageViewByRegion>();
        serdeProps.put("JsonPOJOClass", WindowedPageViewByRegion.class);
        wPageViewByRegionSerializer.configure(serdeProps, false);

        final Deserializer<WindowedPageViewByRegion> wPageViewByRegionDeserializer = new JsonPOJODeserializer<WindowedPageViewByRegion>();
        serdeProps.put("JsonPOJOClass", WindowedPageViewByRegion.class);
        ...
        final Serializer<RegionCount> regionCountSerializer = new JsonPOJOSerializer<RegionCount>();
        serdeProps.put("JsonPOJOClass", RegionCount.class);
        regionCountSerializer.configure(serdeProps, false);

        final Deserializer<RegionCount> regionCountDeserializer = new JsonPOJODeserializer<RegionCount>();
        serdeProps.put("JsonPOJOClass", RegionCount.class);
        ...
        final Serializer<PageViewByRegion> pageViewByRegionSerializer = new JsonPOJOSerializer<PageViewByRegion>();
        serdeProps.put("JsonPOJOClass", PageViewByRegion.class);
        pageViewByRegionSerializer.configure(serdeProps, false);
        final Deserializer<PageViewByRegion> pageViewByRegionDeserializer = new JsonPOJODeserializer<PageViewByRegion>();
        serdeProps.put("JsonPOJOClass", PageViewByRegion.class);
        ...
        KStream<WindowedPageViewByRegion, RegionCount> regionCount = views
                ...
                .map(new KeyValueMapper<String, PageViewByRegion, KeyValue<String, PageViewByRegion>>() {
                    ...
                    public KeyValue<String, PageViewByRegion> apply(String user, PageViewByRegion viewRegion) {
                        return new KeyValue<String, PageViewByRegion>(viewRegion.region, viewRegion);
                    }
                })
                ...
                .map(new KeyValueMapper<Windowed<String>, Long, KeyValue<WindowedPageViewByRegion, RegionCount>>() {
                    ...
                    public KeyValue<WindowedPageViewByRegion, RegionCount> apply(Windowed<String> key, Long value) {
                        ...
                        return new KeyValue<WindowedPageViewByRegion, RegionCount>(wViewByRegion, rCount);
                    }
                });
